...
public class LocationValidator {
    ...
    private static final Set<String> CREATION_REQUIRED_FIELDS = ImmutableSet.of(STREET);
    private static final Set<String> UPDATE_KNOWN_FIELDS = ImmutableSet.of(COUNTRY, STATE, CITY, STREET);
    private static final Set<String> UPDATE_REQUIRED_FIELDS = ImmutableSet.of(STREET);
