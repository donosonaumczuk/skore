        ...
        <div class="sidepanel col-md-4 col-lg-4 offset-xl-1 col-xl-3 navbar-collapse" id="navbarSupportedContent">
            <div class="container-fluid"> <!-- Leftside panel container -->
                ...
                <div class="row filters p-4 mt-2">
                    <div class="container-fluid">
                        <div class="row">
                            <p class="left-panel-title"><spring:message code="filtersAndCategoriesMessage"/><span class="tooltip-icon ml-2 far fa-question-circle" data-toggle="tooltip" data-html="true" data-placement="right" title="<spring:message code="filtersTooltip"/>"/></p>
                        </div>
                        <c:if test="${isLogged}">
